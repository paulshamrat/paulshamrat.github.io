...
# Example usage with 1000 samples
phosphorylated_substrate = [0.05, 0.03, 0.07, 0.02, 0.01, 0.09, 0.04, 0.06, 0.03, 0.08] * 100  # moles
kinase_amount = [0.1, 0.2, 0.15, 0.08, 0.12, 0.25, 0.09, 0.18, 0.1, 0.22] * 100  # moles
assay_time = [60, 90, 120, 60, 90, 120, 60, 90, 120, 60] * 100  # seconds
